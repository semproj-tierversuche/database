...
public class TestClient {
    public static void main(String[] args) throws IOException{
        ...
        WebTarget target = client.target("http://localhost:8080/esapi/documents");
        ...
        Response document = importService.createDocument(tBuilder.toString());
        System.out.println(document);


        // client.register(new LoggingFilter());
        target = client.target("http://localhost:8080/esapi/query");
